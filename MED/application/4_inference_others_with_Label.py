            ...
            for model_type in model_type_list:
                ...
                if re_test or not os.path.exists(preditions_file):
                    ...
                    for n in range(n_samples):
                        ...
                        all_batch_y = []
                        all_pred_y = []
                        generator = DataGenerator_Yuanbo_inference_others(batch_size, inference_audio=inference_audio)
                    ...
                    print('y_preds_all: ', y_preds_all.shape, all_batch_y.shape)  # (30, 3364, 2) (30, 3364, 1)
                ...
                print(y_preds_all.shape, all_batch_y.shape)
                # (30, 665, 2) (665, 1)

                plot_dir = os.path.join(inference_dir, 'plot_' + filename)
                create_folder(plot_dir)
                PE, MI, log_prob = get_results_only_one_class_label(y_preds_all, all_batch_y, plot_dir, filename=filename)
